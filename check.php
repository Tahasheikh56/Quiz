...
<body>
    <div class="container">
    <h1 class="text-center m-5"> <span class=" rounded text-center m-5 text-white bg-primary p-1 me-2">BURAQ TECH </span> WEB DEVELOPER QUIZ <a type="submit" class="btn btn-danger ms-5 p-2" href="logout.php">Logout</a></h1>
...
<?php
        $name  =  $_SESSION["name"];
$finalresult =  "insert into user (uid,username,totalques,answercorrect) value ('', '$name','5','$result')";
